...
| Activity | XP/min | Mana/min |
| --- | --- | --- |
| Matching Research | 144 | 60 |
| Other-school Research | 96 | 60 |

## Crafting

| Recipe | Time |
| --- | --- |
| Fire Fragment (fire-fragment) | 6 s |
| Water Fragment (water-fragment) | 6 s |
| Earth Fragment (earth-fragment) | 6 s |
| Air Fragment (air-fragment) | 6 s |
| Prismatic Fragment (prismatic-fragment) | 18 s |
| Ember Staff (ember-staff) | 8 s |
| Wispwood Wand (wispwood-wand) | 7 s |
| Tide Focus (tide-focus) | 9 s |
| Stoneweave Robe (stoneweave-robe) | 9 s |
| Windthread Charm (windthread-charm) | 9 s |
...
| Razorclaw Circlet (razorclaw-circlet) | 12 s |
...
| Soulward Shield (soulward-shield) | 20 s |
| Acolyte Vestments (acolyte-vestments) | 20 s |
| Wraithveil Hood (wraithveil-hood) | 20 s |
...
| Material | Best Current Source | Est. Qty / Kill | Est. Kills for Common Recipe |
| --- | --- | --- | --- |
| Prismatic Fragment (prismatic-fragment) | Transmutation | — | — |
| Life Essence (life-essence) | Forest Wisp (forest-wisp) — Whispering Woods | 2 | 5 |
| Fire Fragment (fire-fragment) | Transmutation | — | — |
| Water Fragment (water-fragment) | Transmutation | — | — |
| Earth Fragment (earth-fragment) | Transmutation | — | — |

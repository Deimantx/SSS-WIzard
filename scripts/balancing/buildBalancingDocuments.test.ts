...
describe('canonical balancing workbook', () => {
  it('emits the v2 one-page domain structure', () => {
    ...
    expect([...balancing.docs.keys()]).toEqual(expect.arrayContaining(['README.md', 'BALANCE_OVERVIEW.md', 'Combat/Combat.md', 'Dungeons/Whispering_Woods.md', 'Dungeons/Howling_Den.md', 'Dungeons/Abandoned_Catacombs.md', 'Items/Items.md', 'Crafting/Crafting.md', 'Magic/Magic.md', 'Progression/Channeling.md', 'Progression/Research.md', 'Progression/Focus.md', 'Progression/Arcane_Core.md', 'Progression/Guild_And_Unlocks.md', 'Economy/Economy.md']))
  ...
  it('keeps acquisition invariants and stable IDs represented', () => {
    const balancing = buildBalancingDocuments()
    expect(balancing.invariants).toEqual({ recipes: 17, equipment: 12, equipmentRecipeCoverage: 12, directEquipmentLoot: 0 })

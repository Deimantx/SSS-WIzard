...
import { BookOpen, Droplets, FlaskConical, Gem, Home, Library, Package, Settings, Shield, Swords, Target, WandSparkles, Zap } from 'lucide-react'
...
export const navigationGroups: NavigationGroup[] = [
  ...
  { id: 'combat', label: 'Combat', breadcrumb: 'Combat', items: [{ id: 'combat', label: 'Combat', icon: Swords, hint: 'Whispering Woods' }] },
  { id: 'hero', label: 'Hero', breadcrumb: 'Hero', items: [{ id: 'schools', label: 'Magic Schools', icon: BookOpen, hint: 'XP, levels, and spells' }, { id: 'inventory', label: 'Inventory', icon: Package, hint: 'Materials and loot' }, { id: 'equipment', label: 'Equipment', icon: Shield, hint: 'Build your focus' }, { id: 'collection', label: 'Collection', icon: Gem, hint: 'Discover the wilds' }] },
  { id: 'tower', label: 'Wizard Tower', breadcrumb: 'Wizard Tower', items: [{ id: 'tower-channeling', label: 'Channeling', icon: Zap, hint: 'Draw Mana into the tower' }, { id: 'tower-focus', label: 'Focus', icon: Target, hint: 'Review Focus reservations' }, { id: 'tower-condensation', label: 'Condensation', icon: Droplets, hint: 'Turn Mana into fragments' }, { id: 'tower-research', label: 'Research', icon: FlaskConical, hint: 'Deepen a Magic School' }, { id: 'tower-transmutation', label: 'Transmutation', icon: WandSparkles, hint: 'Craft equipment' }] },

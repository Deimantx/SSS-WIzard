...
const SCREEN_LABELS: Record<ScreenId, string> = { home: 'Overview', combat: 'Combat', schools: 'Magic Schools', inventory: 'Inventory', equipment: 'Equipment', 'arcane-core': 'Arcane Core', crystals: 'Crystals', collection: 'Collection', bestiary: 'Bestiary', 'tower-channeling': 'Channeling', 'tower-focus': 'Focus', 'tower-research': 'Research', 'tower-transmutation': 'Transmutation', 'tower-artificing': 'Artificing', 'tower-summoning': 'Summoning', 'tower-dark-portal': 'Dark Portal', guild: 'Guild', settings: 'Settings / Info' }

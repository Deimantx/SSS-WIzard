...
const tabs: { id: DeveloperToolsTab; label: string }[] = [{ id: 'character', label: 'Character' }, { id: 'channeling', label: 'Channeling' }, { id: 'focus', label: 'Focus' }, { id: 'inventory', label: 'Inventory' }, { id: 'combat', label: 'Combat' }, { id: 'schools', label: 'Magic Schools' }, { id: 'progression', label: 'Guild / Progression' }, { id: 'save', label: 'Save / Profile' }, { id: 'diagnostics', label: 'Diagnostics' }]
...
export function DeveloperToolsWindow() {
  ...
  const debugActive = debug.bonusManaRegenFlat > 0 || debug.bonusMaxManaFlat > 0 || debug.bonusMaxFocusFlat > 0 || debug.allowManaOverCap || debug.allowFocusOverCap || debug.ignoreEchoLimit

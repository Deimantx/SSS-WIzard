...
export function normalizeDeveloperToolsTab(tab: string): DeveloperToolsTab {
  ...
  const allowed: DeveloperToolsTab[] = ['quick', 'character', 'progression', 'arcane-core', 'inventory', 'spells', 'research', 'channeling', 'focus', 'transmutation', 'artificing', 'artifacts', 'resonance', 'combat', 'world-tier', 'monsters', 'statuses', 'save', 'diagnostics', 'ui-tuning']

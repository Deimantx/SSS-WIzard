...
export type DeveloperToolsTab = 'quick' | 'character' | 'progression' | 'arcane-core' | 'inventory' | 'spells' | 'research' | 'channeling' | 'focus' | 'transmutation' | 'artificing' | 'artifacts' | 'resonance' | 'combat' | 'monsters' | 'statuses' | 'save' | 'diagnostics' | 'ui-tuning'
...
export function normalizeDeveloperToolsTab(tab: string): DeveloperToolsTab {
  ...
  const allowed: DeveloperToolsTab[] = ['quick', 'character', 'progression', 'arcane-core', 'inventory', 'spells', 'research', 'channeling', 'focus', 'transmutation', 'artificing', 'artifacts', 'resonance', 'combat', 'monsters', 'statuses', 'save', 'diagnostics', 'ui-tuning']

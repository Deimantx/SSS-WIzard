...
export function DeveloperCharacter() {
  ...
  const regen = getManaRegenBreakdown({ activities, progress, equipment, artifactProgress, arcaneCore, player, debug })
  const spellPower = getSpellPowerBreakdown({ activities, progress, player, equipment, artifactProgress, arcaneCore })

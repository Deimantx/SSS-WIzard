...
export function DeveloperFocus() {
  ...
  return <div className="developer-tab-grid">
    ...
    <Card title="Focus availability"><div className="developer-summary-grid"><Summary label="Final Max Focus" value={player.maxFocus} /><Summary label="Used Focus" value={used} /><Summary label="Available Focus" value={free} /><Summary label="Unclamped availability" value={rawFree} /></div><div className="developer-diagnostics"><span>Available Focus is clamped to 0 when reservations exceed capacity.</span><span>Debug mode <b>{debug.allowFocusOverCap ? 'allows over-reservation testing' : 'does not change reservations'}</b>.</span></div></Card>

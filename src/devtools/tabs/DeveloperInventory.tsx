...
const formatPercent = (value: number) => `${(value * 100).toFixed(value * 100 % 1 === 0 ? 0 : 2)}%`
const formatStat = (key: string, value: number) => key.endsWith('Pct') || key === 'critChance' || key === 'critDamage' || key === 'blockChance' ? formatPercent(value) : String(value)

...
const mechanic = (ring: 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8, slot: `S${5 | 6 | 7 | 8}` | 'M', name: string) => arcaneCoreMechanic('power', ring, slot, name)
...
const ring1 = createRing('power', 1, [
  ...
  perk('power-r1-spell-impact', 'Opportunist', 'The next damaging Spell after applying a negative Status gains +1/2/3/4/5% Damage.', mechanic(1, 'S5', 'Opportunist')),
  ...
  perk('power-r1-lingering-power', 'Opening Volley', 'The first damaging Spell of each encounter gains +1/2/3/4/5% Damage.', mechanic(1, 'S7', 'Opening Volley')),
...
const ring4 = createRing('power', 4, [
  ...
  perk('power-r4-dot-mastery', 'Kill Surge', 'Defeating an enemy reduces all remaining Spell cooldowns by 100/200/300/400/500 ms.', mechanic(4, 'S5', 'Kill Surge')),
  perk('power-r4-crushing-pressure', 'Burst Window', 'While any Spell cooldown is ready, damaging Spells gain +2/4/6/8/10% Damage.', mechanic(4, 'S6', 'Burst Window')),
...
const ring5 = createRing('power', 5, [
  ...
  perk('power-r5-blooded-finish', 'Deep Wounds', 'Damaging Spells that apply a periodic Status to an already debuffed enemy deal +2/4/6/8/10% Effect Damage.', mechanic(5, 'S8', 'Deep Wounds')),
...
const ring8 = createRing('power', 8, [
  ...
  perk('power-r8-apotheosis-dot', 'Arcane Echo', 'Every 6th successful damaging Spell creates a separate Arcane hit for 5/10/15/20/25% of its direct damage. It cannot Crit, count as a cast, or retrigger Arcane Echo.', mechanic(8, 'S6', 'Arcane Echo')),
  ...
  perk('power-r8-final-execution', 'Limit Break', 'Once per encounter, a Spell costing at least 20% Max Mana refunds 25% of its final Mana cost.', mechanic(8, 'S8', 'Limit Break')),

...
export const CHANNELING_DISCOVERIES: readonly ChannelingDiscoveryDefinition[] = [
  ...
  { id: 'deep-reservoir', name: 'Deep Reservoir', description: 'The tower learns to hold a deeper reserve of stored leyline power.', conditionDescription: 'Reach 225 Maximum Mana.', rewardDescription: '+25 Max Mana.' },
]

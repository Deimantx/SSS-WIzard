...
export const HOWLING_DEN_DUNGEON = {
  ...
  id: 'howling-den', name: 'Howling Den', threatRequired: 10000, boss: 'corrupted-greatbear', encounterDelayMs: 5000, unlock: { type: 'boss-kill', bossId: 'forest-heart' }, ui: { description: 'A predator-haunted den twisted by unstable magic.' },

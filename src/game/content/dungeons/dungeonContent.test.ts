...
describe('Act 0 and Act 1 dungeon content', () => {
  ...
  it('keeps converted current raw outputs close to their previous authored values', () => {
    const expected: Array<[keyof typeof MONSTERS, string, number, number]> = [
      ['forest-wisp', 'arc-spark', 0, 24], ['thornling', 'thorn-lash', 0, 15], ['stone-root', 'root-slam', 0, 19.8],
      ['grove-sentinel', 'root-crush', 0, 18.9], ['grove-sentinel', 'verdant-guard', 0, 53.333333333333336], ['forest-heart', 'heart-pulse', 0, 36],
      ['forest-heart', 'root-prison', 0, 24], ['forest-heart', 'rejuvenating-sap', 0, 90], ['cavefang-wolf', 'pounce', 0, 30],
      ['razorclaw-lynx', 'rending-claws', 0, 26.25], ['corrupted-dire-wolf', 'arcane-bite', 0, 18.2], ['corrupted-greatbear', 'crushing-maul', 0, 77.5],
      ['corrupted-greatbear', 'groundbreaker', 0, 60], ['corrupted-greatbear', 'arcane-rampage', 0, 100], ['restless-skeleton', 'bone-cleaver', 0, 83.25],
      ['grave-wraith', 'chilling-touch', 0, 72.8], ['fallen-acolyte', 'grave-bolt', 0, 75], ['fallen-acolyte', 'soul-drain', 0, 56.25],
      ['fallen-acolyte', 'soul-drain', 1, 49.5], ['fallen-acolyte', 'death-ward', 0, 112.75], ['archmage-edrin-shade', 'gravefire', 0, 66],
      ['archmage-edrin-shade', 'frostbind', 0, 63], ['archmage-edrin-shade', 'arcane-ward', 0, 120], ['archmage-edrin-shade', 'soul-drain', 0, 72],

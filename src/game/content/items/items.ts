...
const authoredItems: Record<ItemId, AuthoredItemDefinition> = {
  ...
  'stoneweave-robe': equipment({ id: 'stoneweave-robe', name: 'Stoneweave Robe', description: 'A heavy robe that turns barriers into shelter.', icon: '◇', color: '#d5a36b', equipmentSlot: 'armor', stats: { maxHealth: 30, maxMana: 10, defense: 6 }, combat: { modifiers: [{ key: 'barrier-received-flat', value: 10 }] } }),
  ...
  'fangbound-dagger': equipment({ id: 'fangbound-dagger', name: 'Fangbound Dagger', description: 'A quick blade that rewards a steady Basic Attack rhythm.', icon: '/', color: '#d49b75', equipmentSlot: 'weapon', weaponHands: 1, stats: { basicDamage: 14, spellPower: 8, basicAttackSpeedPct: 0.08, critChance: 0.05 } }),
  'fangbound-buckler': equipment({ id: 'fangbound-buckler', name: 'Fangbound Buckler', description: 'A predator’s buckler that turns momentum aside.', icon: 'O', color: '#bd8c6e', equipmentSlot: 'offhand', equipmentPresentation: 'shield', stats: { maxHealth: 35, defense: 12, blockChance: 0.15, resistances: { physical: 0.03 } } }),
  ...
  'greatbear-vestment': equipment({ id: 'greatbear-vestment', name: 'Greatbear Vestment', description: 'A massive vestment built for endurance.', icon: '◇', color: '#806b69', equipmentSlot: 'armor', stats: { maxHealth: 45, maxMana: 10, defense: 12, resistances: { physical: 0.1 } } }),
  'howling-signet': equipment({ id: 'howling-signet', name: 'Howling Signet', description: 'A signet that feeds the hunter after every kill.', icon: 'O', color: '#c18b73', equipmentSlot: 'ring', stats: { maxHealth: 15, maxMana: 20, critChance: 0.02, basicAttackSpeedPct: 0.02 }, combat: { rules: [{ id: 'predators-feast', event: 'on-kill', effects: [{ type: 'heal', target: 'self', magnitude: { type: 'flat', value: 25 } }], ui: { name: "Predator's Feast" } }] } }),
  'greatbear-heartstone': equipment({ id: 'greatbear-heartstone', name: 'Greatbear Heartstone', description: 'A corrupted heartstone that refuses to yield.', icon: 'O', color: '#806b69', equipmentSlot: 'amulet', stats: { maxHealth: 40, healthRegen: 1, defense: 15, resistances: { fire: 0.05, water: 0.05, earth: 0.05, air: 0.05 } }, combat: { rules: [{ id: 'unyielding', event: 'on-hp-threshold', condition: { type: 'self-hp-below-percent', percent: 35 }, oncePerEncounter: true, effects: [{ type: 'gain-barrier', target: 'self', magnitude: { type: 'flat', value: 40 } }], ui: { name: 'Unyielding' } }] } }),

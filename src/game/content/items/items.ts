...
const authoredItems: Record<ItemId, AuthoredItemDefinition> = {
  ...
  'ember-staff': equipment({ id: 'ember-staff', name: 'Ember Staff', description: 'A two-handed Artifact staff that grows with its Artifact Level.', icon: '⚒', color: '#ff956f', equipmentTier: 1.0, buildTags: ['spell', 'fire', 'dot', 'status'], equipmentBudgetProfile: 'signature', equipmentSlot: 'weapon', weaponHands: 2 }),
  'tideglass-wand': equipment({ id: 'tideglass-wand', name: 'Tideglass Wand', description: 'A one-handed Water Artifact that grows with its Artifact Level.', icon: '◇', color: '#64b7ff', equipmentTier: 1.0, buildTags: ['spell', 'water', 'barrier', 'status'], equipmentBudgetProfile: 'signature', equipmentSlot: 'weapon', weaponHands: 1 }),
  'stoneheart-scepter': equipment({ id: 'stoneheart-scepter', name: 'Stoneheart Scepter', description: 'A one-handed Earth Artifact that grows with its Artifact Level.', icon: '⬟', color: '#d5a36b', equipmentTier: 1.0, buildTags: ['spell', 'earth', 'defense', 'barrier'], equipmentBudgetProfile: 'signature', equipmentSlot: 'weapon', weaponHands: 1 }),
  'windthread-wand': equipment({ id: 'windthread-wand', name: 'Windthread Wand', description: 'A one-handed Air Artifact that grows with its Artifact Level.', icon: '~', color: '#b9d8d0', equipmentTier: 1.0, buildTags: ['spell', 'air', 'crit', 'mana'], equipmentBudgetProfile: 'signature', equipmentSlot: 'weapon', weaponHands: 1 }),
  'prismatic-focus': equipment({ id: 'prismatic-focus', name: 'Prismatic Focus', description: 'A harmonized focus Artifact that grows with its Artifact Level.', icon: '◈', color: '#c8a8ff', equipmentTier: 1.0, buildTags: ['spell', 'mana', 'barrier', 'focus'], equipmentBudgetProfile: 'signature', equipmentSlot: 'offhand', equipmentPresentation: 'focus' }),
  'wispweave-robe': equipment({ id: 'wispweave-robe', name: 'Wispweave Robe', description: 'A protective Wisp Artifact that grows with its Artifact Level.', icon: '◇', color: '#a9b8d8', equipmentTier: 1.0, buildTags: ['defense', 'sustain', 'barrier', 'mana'], equipmentBudgetProfile: 'signature', equipmentSlot: 'armor' }),
  ...
  'wispveil-hood': equipment({ id: 'wispveil-hood', name: 'Wispveil Hood', description: 'A purple Wispveil Artifact that grows with its Artifact Level.', icon: '◇', color: '#b8a8e8', equipmentTier: 1.0, buildTags: ['spell', 'mana', 'status', 'crit'], equipmentBudgetProfile: 'signature', equipmentSlot: 'helmet' }),
...
const sellValues: Record<ItemId, number | null> = {
  ...
  'ember-staff': null, 'tideglass-wand': null, 'stoneheart-scepter': null, 'windthread-wand': null, 'prismatic-focus': null, 'wispweave-robe': null, 'windthread-charm': 40, 'wispveil-hood': null, 'grovekeeper-mantle': 40, 'wispbound-ring': 40, 'heartseed-necklace': null,
  'predator-fang': 4, 'predator-hide': 5, 'corrupted-beast-essence': 6, 'greatbear-core': 20, 'predator-hide-mantle': 70, 'howling-signet': 70, 'greatbear-heartstone': null,
  'ossuary-remnant': 4, 'graveglass-shard': 5, 'soul-residue': 6, 'edrin-remnant': 20, 'ossuary-mantle': 110, 'soulglass-amulet': 110, 'gravebinder-ring': 110, 'edrins-signet': null,
}

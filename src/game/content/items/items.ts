...
const authoredItems: Record<ItemId, AuthoredItemDefinition> = {
  ...
  'ember-staff': equipment({ id: 'ember-staff', name: 'Ember Staff', description: 'A two-handed staff that makes Fire spells burn brighter.', icon: '⚒', color: '#ff956f', equipmentTier: 1.0, buildTags: ['spell', 'fire'], equipmentBudgetProfile: 'signature', equipmentSlot: 'weapon', weaponHands: 2, stats: { basicDamage: 6, maxMana: 10, spellPower: 24 }, combat: { modifiers: [{ key: 'spell-damage-percent', value: 0.2, sourceKinds: ['spell'], damageTypes: ['fire'] }] } }),

...
const authoredItems: Record<ItemId, AuthoredItemDefinition> = {
  ...
  'ember-staff': equipment({ id: 'ember-staff', name: 'Ember Staff', description: 'A two-handed staff that strengthens Fire spell hits and the Burning they apply.', icon: '⚒', color: '#ff956f', equipmentTier: 1.0, buildTags: ['spell', 'fire'], equipmentBudgetProfile: 'signature', equipmentSlot: 'weapon', weaponHands: 2, stats: { basicDamage: 6, maxMana: 10, spellPower: 24 }, combat: { modifiers: [{ key: 'spell-damage-percent', value: 0.2, originSourceKinds: ['spell'], damageTypes: ['fire'] }] } }),
  ...
  'windthread-charm': equipment({ id: 'windthread-charm', name: 'Windthread Charm', description: 'A charm that leaves room for one more automation.', icon: '~', color: '#b9d8d0', equipmentTier: 1.0, buildTags: ['spell', 'air', 'focus'], equipmentBudgetProfile: 'signature', equipmentSlot: 'amulet', stats: { maxMana: 10, maxFocus: 10, spellPower: 8 }, combat: { modifiers: [{ key: 'spell-damage-percent', value: 0.1, sourceKinds: ['spell'], damageTypes: ['air'] }] } }),

...
const authoredItems: Record<ItemId, AuthoredItemDefinition> = {
  ...
  'ember-staff': { id: 'ember-staff', name: 'Ember Staff', description: 'A staff that makes every basic hit burn brighter.', icon: '⚒', color: '#ff956f', kind: 'equipment', category: 'equipment', source: 'Transmutation', equipmentSlot: 'weapon', weaponHands: 2, stats: { basicDamage: 4, maxMana: 10, fireSpellDamagePct: 0.2 } },
  'tide-focus': { id: 'tide-focus', name: 'Tide Focus', description: 'A fluid focus that deepens Water barriers.', icon: '◈', color: '#64b7ff', kind: 'equipment', category: 'equipment', source: 'Transmutation', equipmentSlot: 'offhand', stats: { maxMana: 15, waterBarrierPct: 0.2 } },
  ...
  'windthread-charm': { id: 'windthread-charm', name: 'Windthread Charm', description: 'A charm that leaves room for one more automation.', icon: '⌁', color: '#b9d8d0', kind: 'equipment', category: 'equipment', source: 'Transmutation', equipmentSlot: 'amulet', stats: { maxFocus: 10, airSpellDamagePct: 0.1 } },
}

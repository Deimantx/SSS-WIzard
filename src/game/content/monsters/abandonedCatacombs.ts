...
export const ABANDONED_CATACOMBS_MONSTERS = {
  'restless-skeleton': {
    ...
    loot: withLifeEssence([{ itemId: 'ossuary-remnant', min: 1, max: 2, chance: 0.2 }, { itemId: 'graveglass-shard', min: 1, max: 1, chance: 0.1 }], { min: 4, max: 8 }),
  },
  'grave-wraith': {
    ...
    loot: withLifeEssence([{ itemId: 'soul-residue', min: 1, max: 2, chance: 0.2 }, { itemId: 'graveglass-shard', min: 1, max: 1, chance: 0.1 }], { min: 4, max: 8 }),
  },
  'fallen-acolyte': {
    ...
    loot: withLifeEssence([{ itemId: 'burial-cloth', min: 1, max: 2, chance: 0.2 }, { itemId: 'graveglass-shard', min: 1, max: 1, chance: 0.1 }], { min: 5, max: 10 }),
  },

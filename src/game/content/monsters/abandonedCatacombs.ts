...
export const ABANDONED_CATACOMBS_MONSTERS = {
  'restless-skeleton': {
    ...
    maxHealth: 680, basicAttackDamage: 35, basicAttackTimeMs: 2700, defense: 30, color: '#c9c3ae', ui: { portraitIcon: 'skeleton' }, traitIds: ['restless-skeleton-brittle-bones'], resistances: { physical: 0.25 },
  ...
  'grave-wraith': {
    ...
    maxHealth: 600, basicAttackDamage: 36, basicAttackTimeMs: 2400, defense: 20, color: '#8d9dc9', ui: { portraitIcon: 'ghost' }, traitIds: ['grave-wraith-ethereal-form'], resistances: { physical: 0.5, fire: -0.25, water: -0.25, earth: -0.25, air: -0.25 },
    actions: {
  ...
  'fallen-acolyte': {
    ...
    maxHealth: 550, basicAttackDamage: 30, basicAttackTimeMs: 2600, defense: 18, color: '#9b7eaa', ui: { portraitIcon: 'mage' }, traitIds: ['fallen-acolyte-grave-channeling'],
    actions: {
  ...
  'archmage-edrin-shade': {
    ...
    maxHealth: 5800, basicAttackDamage: 65, basicAttackTimeMs: 2500, defense: 45, color: '#70619b', ui: { portraitIcon: 'mage' }, traitIds: ['archmage-edrin-arcane-remnant', 'archmage-edrin-unbound-spirit'], resistances: { fire: 0.15, water: 0.15, earth: 0.15, air: 0.15 },
    actions: {

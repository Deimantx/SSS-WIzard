...
export const ABANDONED_CATACOMBS_MONSTERS = {
  'restless-skeleton': {
    ...
    loot: withLifeEssence([{ itemId: 'ossuary-remnant', min: 1, max: 2, chance: 0.27 }, { itemId: 'graveglass-shard', min: 1, max: 1, chance: 0.13 }], { min: 4, max: 8 }),
  },
  'grave-wraith': {
    id: 'grave-wraith', bestiaryCategory: 'monster', name: 'Grave Wraith', subtitle: 'A cold memory refusing to fade',
    maxHealth: 600, basicAttackDamage: 56, basicAttackTimeMs: 2400, defense: 20, color: '#8d9dc9', ui: { portraitIcon: 'ghost' }, traitIds: ['grave-wraith-ethereal-form'], resistances: { physical: 0.5, fire: -0.25, water: -0.25, earth: -0.25, air: -0.25 },
    actions: {
    ...
    loot: withLifeEssence([{ itemId: 'soul-residue', min: 1, max: 2, chance: 0.27 }, { itemId: 'graveglass-shard', min: 1, max: 1, chance: 0.13 }], { min: 4, max: 8 }),
  },
  'fallen-acolyte': {
    id: 'fallen-acolyte', bestiaryCategory: 'monster', name: 'Fallen Acolyte', subtitle: 'A ritualist still serving a forgotten master',
    maxHealth: 550, basicAttackDamage: 50, basicAttackTimeMs: 2600, defense: 18, color: '#9b7eaa', ui: { portraitIcon: 'mage' }, traitIds: ['fallen-acolyte-grave-channeling'],
    actions: {
    ...
    loot: withLifeEssence([{ itemId: 'burial-cloth', min: 1, max: 2, chance: 0.27 }, { itemId: 'graveglass-shard', min: 1, max: 1, chance: 0.13 }], { min: 5, max: 10 }),
  },
  'archmage-edrin-shade': {
    ...
    maxHealth: 6800, basicAttackDamage: 75, basicAttackTimeMs: 2500, defense: 45, color: '#70619b', ui: { portraitIcon: 'mage' }, traitIds: ['archmage-edrin-arcane-remnant', 'archmage-edrin-unbound-spirit'], resistances: { fire: 0.15, water: 0.15, earth: 0.15, air: 0.15 },
    actions: {
    ...
    loot: withLifeEssence([
      { itemId: 'ossuary-remnant', min: 1, max: 2, chance: 1 },
      { itemId: 'soul-residue', min: 1, max: 2, chance: 1 },
      { itemId: 'graveglass-shard', min: 1, max: 2, chance: 1 },
      { itemId: 'burial-cloth', min: 1, max: 2, chance: 1 },

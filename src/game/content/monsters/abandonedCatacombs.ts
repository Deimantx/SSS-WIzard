...
export const ABANDONED_CATACOMBS_MONSTERS = {
  'restless-skeleton': {
    ...
    maxHealth: 180, basicAttackDamage: 15, actionIntervalMs: 2700, color: '#c9c3ae', ui: { portraitIcon: 'skeleton' }, traitIds: ['restless-skeleton-brittle-bones'], resistances: { physical: 0.25 },
  ...
  'grave-wraith': {
    ...
    maxHealth: 160, basicAttackDamage: 14, actionIntervalMs: 2400, color: '#8d9dc9', ui: { portraitIcon: 'ghost' }, traitIds: ['grave-wraith-ethereal-form'], resistances: { physical: 0.5, fire: -0.25, water: -0.25, earth: -0.25, air: -0.25 },
    actions: {
  ...
  'fallen-acolyte': {
    ...
    maxHealth: 220, basicAttackDamage: 16, actionIntervalMs: 2600, color: '#9b7eaa', ui: { portraitIcon: 'mage' }, traitIds: ['fallen-acolyte-grave-channeling'],
    actions: {
  ...
  'archmage-edrin-shade': {
    ...
    maxHealth: 1300, basicAttackDamage: 20, actionIntervalMs: 2500, color: '#70619b', ui: { portraitIcon: 'mage' }, traitIds: ['archmage-edrin-arcane-remnant', 'archmage-edrin-unbound-spirit'], resistances: { fire: 0.15, water: 0.15, earth: 0.15, air: 0.15 },
    actions: {

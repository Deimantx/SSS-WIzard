...
export const ABANDONED_CATACOMBS_MONSTERS = {
  'restless-skeleton': {
    ...
    actions: { 'bone-cleaver': { id: 'bone-cleaver', name: 'Bone Cleaver', actionTimeMs: 2200, description: 'Deals 28 Physical damage.', effects: [directDamage('physical', 28)], tags: ['special', 'physical', 'melee', 'direct'] } },
  ...
  'grave-wraith': {
    ...
    actions: {
      'chilling-touch': { id: 'chilling-touch', name: 'Chilling Touch', actionTimeMs: 1800, description: 'Deals 18 Water damage and applies Chilled.', effects: [directDamage('water', 18), applyStatus('chilled', 'opponent')], tags: ['special', 'water', 'magic', 'debuff'] },
      fade: { id: 'fade', name: 'Fade', actionTimeMs: 1700, description: 'Applies Spectral Fade to self for 5 seconds.', effects: [applyStatus('spectral-fade', 'self', 5000)], tags: ['special', 'buff'] },
    },
  ...
  'fallen-acolyte': {
    ...
    actions: {
      'grave-bolt': { id: 'grave-bolt', name: 'Grave Bolt', actionTimeMs: 1500, description: 'Deals 24 Arcane damage.', effects: [directDamage('arcane', 24)], tags: ['special', 'arcane', 'magic', 'direct'] },
      'soul-drain': { id: 'soul-drain', name: 'Soul Drain', actionTimeMs: 2200, description: 'Deals 18 Arcane damage and heals self for 20 HP.', effects: [directDamage('arcane', 18), heal(20)], tags: ['special', 'arcane', 'magic', 'heal', 'direct'] },
      'death-ward': { id: 'death-ward', name: 'Death Ward', actionTimeMs: 2000, description: 'Gains 45 Barrier.', effects: [gainBarrier({ type: 'flat', value: 45 })], tags: ['special', 'barrier'] },
    },
  ...
  'archmage-edrin-shade': {
    ...
    actions: {
      gravefire: { id: 'gravefire', name: 'Gravefire', actionTimeMs: 1800, description: 'Deals 28 Fire damage and applies Burning.', effects: [directDamage('fire', 28), applyStatus('burning', 'opponent')], tags: ['special', 'fire', 'magic', 'debuff'] },
      frostbind: { id: 'frostbind', name: 'Frostbind', actionTimeMs: 2000, description: 'Deals 24 Water damage and applies Chilled.', effects: [directDamage('water', 24), applyStatus('chilled', 'opponent')], tags: ['special', 'water', 'magic', 'debuff'] },
      'arcane-ward': { id: 'arcane-ward', name: 'Arcane Ward', actionTimeMs: 2200, description: 'Gains 70 Barrier.', effects: [gainBarrier({ type: 'flat', value: 70 })], tags: ['special', 'arcane', 'barrier'] },
      'soul-drain': { id: 'soul-drain', name: 'Soul Drain', actionTimeMs: 2400, description: 'Deals 24 Arcane damage and heals self for 30 HP.', effects: [directDamage('arcane', 24), heal(30)], tags: ['special', 'arcane', 'magic', 'heal', 'direct'] },
      'final-incantation': { id: 'final-incantation', name: 'Final Incantation', actionTimeMs: 4500, description: 'A devastating Arcane spell for 70 damage.', effects: [directDamage('arcane', 70)], tags: ['special', 'arcane', 'magic', 'direct'] },
    },
    actionPatterns: {

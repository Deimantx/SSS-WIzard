  ...
  "archmage-edrin-shade": {
    ...
    actions: {
      ...
      "soul-drain": {
        ...
        actionTimeMs: 2400,
        description:
          "Arcane force tears at the target and restores Health equal to the actual Health damage dealt.",
        effects: [scaledDirectDamage("arcane", 1.5, ["direct"], 1.0)],
        tags: ["special", "arcane", "magic", "heal", "direct"],
      },
      "arcane-disruption": {
        ...
        effects: [
          {
            type: "deal-damage",
            target: "opponent",
            components: [{ damageType: "arcane", magnitude: sourceStatusStackScaled("final-incantation-empowerment", { type: "source-basic-damage-percent", value: 2.0 }, 0.1) }],
            tags: ["direct"],
          },
          { type: "apply-status", target: "self", statusId: "final-incantation-empowerment", stacks: 1 },
        ],
        tags: ["special", "arcane", "magic", "direct"],
      },
    },
    actionPatterns: {
      default: {
        ...
        steps: [
          ...
          basic("basic-2"),
          action("gravefire-step-2", "gravefire"),
          action("soul-drain-step-1", "soul-drain"),
          basic("basic-3"),
          basic("basic-4"),
          action("frostbind-step-2", "frostbind"),
          action("soul-drain-step-2", "soul-drain"),
        ],
      },
      "unbound-opening": {
        id: "unbound-opening",

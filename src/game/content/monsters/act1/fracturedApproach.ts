...
import { action, basic, scaledBarrier, scaledDirectDamage, withDungeonLoot, type MonsterDefinition } from './monsterTypes'
...
export const FRACTURED_APPROACH_MONSTERS = {
  'warded-husk': {
    ...
    maxHealth: 1000, basicAttackDamage: 58, basicAttackTimeMs: 2800, defense: 40, resistances: { physical: 0.10, arcane: 0.15 }, color: '#8c806f', ui: { portraitIcon: 'guardian' }, traitIds: [],
    actions: {
  ...
  'rift-wolf': {
    ...
    maxHealth: 780, basicAttackDamage: 63, basicAttackTimeMs: 2050, defense: 24, resistances: { air: 0.10, earth: -0.10 }, color: '#7da8bd', ui: { portraitIcon: 'wolf' }, traitIds: [],
    actions: {
  ...
  'arcane-scavenger': {
    ...
    maxHealth: 840, basicAttackDamage: 61, basicAttackTimeMs: 2350, defense: 26, resistances: { arcane: 0.15, physical: -0.05 }, color: '#a78bc4', ui: { portraitIcon: 'mage' }, traitIds: [],
    actions: {
  ...
  'withered-watcher': {
    ...
    maxHealth: 920, basicAttackDamage: 60, basicAttackTimeMs: 2550, defense: 34, resistances: { fire: 0.05, water: 0.05, earth: 0.05, air: 0.05 }, color: '#9a8c79', ui: { portraitIcon: 'guardian' }, traitIds: [],
    actions: {
  ...
  'corrupted-elemental-gatekeeper': {
    ...
    maxHealth: 8500, basicAttackDamage: 75, basicAttackTimeMs: 2450, defense: 55, resistances: { physical: 0.10, fire: 0.10, water: 0.10, earth: 0.10, air: 0.10 }, color: '#d276a3', ui: { portraitIcon: 'boss' }, traitIds: [],
    actions: {

...
export const HOWLING_DEN_MONSTERS = {
  'cavefang-wolf': {
    ...
    maxHealth: 350, basicAttackDamage: 30, basicAttackTimeMs: 2200, defense: 16, color: '#b8a0a0', ui: { portraitIcon: 'wolf' }, traitIds: ['cavefang-wolf-predator-instinct'],
  ...
  'razorclaw-lynx': {
    ...
    maxHealth: 360, basicAttackDamage: 33, basicAttackTimeMs: 1900, defense: 16, color: '#c18b73', ui: { portraitIcon: 'claw' }, traitIds: ['razorclaw-lynx-relentless-hunter'],
  ...
  'corrupted-dire-wolf': {
    ...
    maxHealth: 420, basicAttackDamage: 36, basicAttackTimeMs: 2300, defense: 16, color: '#7e6c9f', ui: { portraitIcon: 'wolf' }, traitIds: ['corrupted-dire-wolf-arcane-corruption'], resistances: { fire: 0.1, water: 0.1, earth: 0.1, air: 0.1 },
    actions: {
  ...
  'corrupted-greatbear': {
    ...
    maxHealth: 2400, basicAttackDamage: 55, basicAttackTimeMs: 2800, defense: 30, color: '#806b69', ui: { portraitIcon: 'bear' }, traitIds: ['corrupted-greatbear-thick-hide', 'corrupted-greatbear-unstable-corruption'],
    actions: {

...
export const HOWLING_DEN_MONSTERS = {
  'cavefang-wolf': {
    ...
    loot: withLifeEssence([{ itemId: 'predator-fang', min: 1, max: 2, chance: 0.3}, { itemId: 'predator-hide', min: 1, max: 1, chance: 0.25}], { min: 3, max: 5 }),
  },
  'razorclaw-lynx': {
    ...
    loot: withLifeEssence([{ itemId: 'predator-sinew', min: 1, max: 2, chance: 0.5}, { itemId: 'predator-hide', min: 1, max: 1, chance: 0.15 }], { min: 3, max: 5 }),
  },
  'corrupted-dire-wolf': {
    id: 'corrupted-dire-wolf', bestiaryCategory: 'monster', name: 'Corrupted Dire Wolf', subtitle: 'A beast split between fang and sorcery',
    maxHealth: 420, basicAttackDamage: 26, basicAttackTimeMs: 2300, defense: 13, color: '#7e6c9f', ui: { portraitIcon: 'wolf' }, traitIds: ['corrupted-dire-wolf-arcane-corruption'], resistances: { fire: 0.1, water: 0.1, earth: 0.1, air: 0.1 },
    actions: {
    ...
    loot: withLifeEssence([{ itemId: 'corrupted-beast-essence', min: 1, max: 2, chance: 0.35 }, { itemId: 'predator-hide', min: 1, max: 1, chance: 0.25 }], { min: 3, max: 5 }),
  },
  'corrupted-greatbear': {
    ...
    loot: withLifeEssence([
      { itemId: 'predator-fang', min: 2, max: 3, chance: 1 },
      { itemId: 'predator-hide', min: 2, max: 3, chance: 1 },
      { itemId: 'corrupted-beast-essence', min: 1, max: 3, chance: 1 },
      { itemId: 'predator-sinew', min: 2, max: 4, chance: 1 },
      { itemId: 'greatbear-core', min: 1, max: 1, chance: 1 },
    ], { min: 12, max: 30 }),
  },

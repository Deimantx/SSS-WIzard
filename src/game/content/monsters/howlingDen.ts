...
export const HOWLING_DEN_MONSTERS = {
  'cavefang-wolf': {
    ...
    maxHealth: 115, basicAttackDamage: 12, actionIntervalMs: 2200, color: '#b8a0a0', ui: { portraitIcon: 'wolf' }, traitIds: ['cavefang-wolf-predator-instinct'],
  ...
  'razorclaw-lynx': {
    ...
    maxHealth: 130, basicAttackDamage: 11, actionIntervalMs: 1900, color: '#c18b73', ui: { portraitIcon: 'claw' }, traitIds: ['razorclaw-lynx-relentless-hunter'],
  ...
  'corrupted-dire-wolf': {
    ...
    maxHealth: 160, basicAttackDamage: 14, actionIntervalMs: 2300, color: '#7e6c9f', ui: { portraitIcon: 'wolf' }, traitIds: ['corrupted-dire-wolf-arcane-corruption'], resistances: { fire: 0.1, water: 0.1, earth: 0.1, air: 0.1 },
    actions: {
  ...
  'corrupted-greatbear': {
    ...
    maxHealth: 900, basicAttackDamage: 22, actionIntervalMs: 2800, color: '#806b69', ui: { portraitIcon: 'bear' }, traitIds: ['corrupted-greatbear-thick-hide', 'corrupted-greatbear-unstable-corruption'],
    actions: {

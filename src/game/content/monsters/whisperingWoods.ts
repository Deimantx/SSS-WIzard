...
export const WHISPERING_WOODS_MONSTERS = {
  'forest-wisp': {
    ...
    maxHealth: 44, basicAttackDamage: 5, actionIntervalMs: 2800, color: '#aa9aff', ui: { portraitIcon: 'wisp' }, traitIds: ['forest-wisp-flicker'],
  ...
  thornling: {
    ...
    maxHealth: 64, basicAttackDamage: 8, actionIntervalMs: 2500, color: '#cb7899', ui: { portraitIcon: 'plant' }, traitIds: ['thornling-barkskin'],
  ...
  'stone-root': {
    ...
    maxHealth: 92, basicAttackDamage: 11, actionIntervalMs: 3200, color: '#b28f79', ui: { portraitIcon: 'stone' }, traitIds: ['stone-rooted-shell'],
  ...
  'grove-sentinel': {
    ...
    maxHealth: 360, basicAttackDamage: 15, actionIntervalMs: 2600, color: '#d39b59', ui: { portraitIcon: 'guardian' }, traitIds: ['grove-sentinel-ancient-growth'],
    actions: {
  ...
  'forest-heart': {
    ...
    maxHealth: 600, basicAttackDamage: 20, actionIntervalMs: 2400, color: '#e06c8b', ui: { portraitIcon: 'boss' }, traitIds: ['forest-heart-living-core'],
    actions: {

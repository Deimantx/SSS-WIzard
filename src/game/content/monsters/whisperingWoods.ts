...
export const WHISPERING_WOODS_MONSTERS = {
  'forest-wisp': {
    ...
    actions: { 'arc-spark': { id: 'arc-spark', name: 'Arc Spark', actionTimeMs: 2000, description: 'A bright Arcane spark strikes for 12 damage.', effects: [directDamage('arcane', 12)], tags: ['special', 'magic', 'arcane', 'direct'] } },
  ...
  thornling: {
    ...
    actions: { 'thorn-lash': { id: 'thorn-lash', name: 'Thorn Lash', actionTimeMs: 1800, description: 'Deals 10 Physical damage and applies Thorn Wound.', effects: [directDamage('physical', 10), applyStatus('thorn-wound', 'opponent')], tags: ['special', 'physical', 'debuff'] } },
  ...
  'stone-root': {
    ...
    actions: { 'root-slam': { id: 'root-slam', name: 'Root Slam', actionTimeMs: 2500, description: 'Deals 18 Physical damage and delays the player Basic Attack by 700ms.', effects: [directDamage('physical', 18), delayBasicAttack(700)], tags: ['special', 'physical', 'control'] } },
  ...
  'grove-sentinel': {
    ...
    actions: {
      'root-crush': { id: 'root-crush', name: 'Root Crush', actionTimeMs: 2000, description: 'Deals 20 Physical damage.', effects: [directDamage('physical', 20)], tags: ['special', 'physical', 'direct'] },
      'verdant-guard': { id: 'verdant-guard', name: 'Verdant Guard', actionTimeMs: 2500, description: 'Gains 60 Barrier.', effects: [gainBarrier({ type: 'flat', value: 60 })], tags: ['special', 'barrier'] },
    },
  ...
  'forest-heart': {
    ...
    actions: {
      'heart-pulse': { id: 'heart-pulse', name: 'Heart Pulse', actionTimeMs: 2000, description: 'Deals 24 Physical damage.', effects: [directDamage('physical', 24)], tags: ['special', 'physical', 'direct'] },
      'root-prison': { id: 'root-prison', name: 'Root Prison', actionTimeMs: 2000, description: 'Deals 16 Physical damage and delays the player Basic Attack by 1000ms.', effects: [directDamage('physical', 16), delayBasicAttack(1000)], tags: ['special', 'physical', 'control'] },
      'rejuvenating-sap': { id: 'rejuvenating-sap', name: 'Rejuvenating Sap', actionTimeMs: 3000, description: 'Heals 60 HP.', effects: [heal(60)], tags: ['special', 'heal', 'direct'] },
    },

...
export const WHISPERING_WOODS_MONSTERS = {
  'forest-wisp': {
    ...
    maxHealth: 200, basicAttackDamage: 5, basicAttackTimeMs: 2800, defense: 8, color: '#aa9aff', ui: { portraitIcon: 'wisp' }, traitIds: ['forest-wisp-flicker'],
  ...
  thornling: {
    ...
    maxHealth: 240, basicAttackDamage: 8, basicAttackTimeMs: 2500, defense: 12, color: '#cb7899', ui: { portraitIcon: 'plant' }, traitIds: ['thornling-barkskin'],
  ...
  'stone-root': {
    ...
    maxHealth: 280, basicAttackDamage: 11, basicAttackTimeMs: 3200, defense: 12, color: '#b28f79', ui: { portraitIcon: 'stone' }, traitIds: ['stone-rooted-shell'],
  ...
  'grove-sentinel': {
    ...
    maxHealth: 320, basicAttackDamage: 15, basicAttackTimeMs: 2600, defense: 20, color: '#d39b59', ui: { portraitIcon: 'guardian' }, traitIds: ['grove-sentinel-ancient-growth'],
    actions: {
  ...
  'forest-heart': {
    ...
    maxHealth: 800, basicAttackDamage: 25, basicAttackTimeMs: 2400, defense: 30, color: '#e06c8b', ui: { portraitIcon: 'boss' }, traitIds: ['forest-heart-living-core'],
    actions: {

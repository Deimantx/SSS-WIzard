...
export const RECIPES: Record<RecipeId, RecipeDefinition> = {
  ...
  'ember-staff': equipmentRecipe('ember-staff', 'Ember Staff', [{ itemId: 'fire-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 8000, groveSentinel, 'A staff that makes every Fire spell burn brighter.'),
  'wispwood-wand': equipmentRecipe('wispwood-wand', 'Wispwood Wand', [{ itemId: 'fire-fragment', quantity: 12 }, { itemId: 'air-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 7000, groveSentinel, 'A flexible one-handed caster weapon.'),
  'tide-focus': equipmentRecipe('tide-focus', 'Tide Focus', [{ itemId: 'water-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 9000, groveSentinel, 'A fluid focus that deepens Water barriers.'),
  'stoneweave-robe': equipmentRecipe('stoneweave-robe', 'Stoneweave Robe', [{ itemId: 'earth-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 9000, groveSentinel, 'A heavy robe that turns barriers into shelter.'),
  'windthread-charm': equipmentRecipe('windthread-charm', 'Windthread Charm', [{ itemId: 'air-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 9000, groveSentinel, 'A charm that leaves room for one more automation.'),
  'wispveil-hood': equipmentRecipe('wispveil-hood', 'Wispveil Hood', [{ itemId: 'water-fragment', quantity: 12 }, { itemId: 'air-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 10000, groveSentinel, 'A steady hood for the early caster.'),
  'grovekeeper-mantle': equipmentRecipe('grovekeeper-mantle', 'Grovekeeper Mantle', [{ itemId: 'earth-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 10000, groveSentinel, 'A mantle of early survivability.'),
  'wispbound-ring': equipmentRecipe('wispbound-ring', 'Wispbound Ring', [{ itemId: 'water-fragment', quantity: 12 }, { itemId: 'air-fragment', quantity: 12 }, { itemId: 'wisp-essence', quantity: 6 }, { itemId: 'grove-bark', quantity: 3 }], 8000, groveSentinel, 'A ring for Mana and utility.'),
  ...
  'fangbound-dagger': equipmentRecipe('fangbound-dagger', 'Fangbound Dagger', [{ itemId: 'predator-fang', quantity: 5 }, { itemId: 'air-fragment', quantity: 2 }, { itemId: 'fire-fragment', quantity: 2 }], 12000, howlingDen, 'A quick blade for Basic Attack builds.'),
  'fangbound-buckler': equipmentRecipe('fangbound-buckler', 'Fangbound Buckler', [{ itemId: 'predator-hide', quantity: 4 }, { itemId: 'predator-fang', quantity: 5 }, { itemId: 'earth-fragment', quantity: 3 }], 12000, howlingDen, 'A defensive one-handed offhand.'),
  'corrupted-howlstaff': equipmentRecipe('corrupted-howlstaff', 'Corrupted Howlstaff', [{ itemId: 'greatbear-core', quantity: 3 }, { itemId: 'corrupted-beast-essence', quantity: 4 }, { itemId: 'air-fragment', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 18000, howlingDen, 'A fast multi-school spellcaster staff.'),
  'razorclaw-circlet': equipmentRecipe('razorclaw-circlet', 'Razorclaw Circlet', [{ itemId: 'predator-fang', quantity: 5 }, { itemId: 'predator-hide', quantity: 4 }, { itemId: 'air-fragment', quantity: 2 }], 12000, howlingDen, 'A circlet for Crit and speed.'),
  'predator-hide-mantle': equipmentRecipe('predator-hide-mantle', 'Predator-Hide Mantle', [{ itemId: 'predator-hide', quantity: 4 }, { itemId: 'earth-fragment', quantity: 3 }], 12000, howlingDen, 'Physical and status protection from the hunt.'),
  'greatbear-vestment': equipmentRecipe('greatbear-vestment', 'Greatbear Vestment', [{ itemId: 'predator-hide', quantity: 4 }, { itemId: 'greatbear-core', quantity: 3 }, { itemId: 'earth-fragment', quantity: 4 }], 18000, howlingDen, 'A tank vestment built for endurance.'),
  'howling-signet': equipmentRecipe('howling-signet', 'Howling Signet', [{ itemId: 'corrupted-beast-essence', quantity: 4 }, { itemId: 'predator-fang', quantity: 5 }, { itemId: 'water-fragment', quantity: 2 }, { itemId: 'air-fragment', quantity: 2 }], 14000, howlingDen, 'A ring that sustains long combat runs.'),
  'greatbear-heartstone': equipmentRecipe('greatbear-heartstone', 'Greatbear Heartstone', [{ itemId: 'greatbear-core', quantity: 3 }], 18000, { type: 'boss-kill', bossId: 'corrupted-greatbear' }, 'Greatbear cores fused into an unyielding heartstone.'),

  'graveglass-wand': equipmentRecipe('graveglass-wand', 'Graveglass Wand', [{ itemId: 'graveglass-shard', quantity: 5 }, { itemId: 'soul-residue', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 18000, abandonedCatacombs, 'A one-handed wand for efficient spellcasting.'),
  'edrins-remnant-staff': equipmentRecipe('edrins-remnant-staff', "Edrin's Remnant Staff", [{ itemId: 'edrin-remnant', quantity: 5 }, { itemId: 'graveglass-shard', quantity: 5 }, { itemId: 'soul-residue', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 4 }], 30000, { type: 'boss-kill', bossId: 'archmage-edrin-shade' }, 'A high-end staff for status builds.'),
  'soulward-focus': equipmentRecipe('soulward-focus', 'Soulward Focus', [{ itemId: 'soul-residue', quantity: 3 }, { itemId: 'graveglass-shard', quantity: 5 }, { itemId: 'water-fragment', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 20000, abandonedCatacombs, 'A focus that turns broken Barriers into Mana.'),
  'soulward-shield': equipmentRecipe('soulward-shield', 'Soulward Shield', [{ itemId: 'ossuary-remnant', quantity: 4 }, { itemId: 'graveglass-shard', quantity: 5 }, { itemId: 'earth-fragment', quantity: 4 }, { itemId: 'prismatic-fragment', quantity: 2 }], 20000, abandonedCatacombs, 'A defensive caster shield.'),
  'acolyte-vestments': equipmentRecipe('acolyte-vestments', 'Acolyte Vestments', [{ itemId: 'soul-residue', quantity: 3 }, { itemId: 'ossuary-remnant', quantity: 4 }, { itemId: 'water-fragment', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 20000, abandonedCatacombs, 'Elemental-resistant defensive caster wear.'),
  'wraithveil-hood': equipmentRecipe('wraithveil-hood', 'Wraithveil Hood', [{ itemId: 'soul-residue', quantity: 3 }, { itemId: 'graveglass-shard', quantity: 5 }, { itemId: 'air-fragment', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 20000, abandonedCatacombs, 'A hood for status casters.'),
  'ossuary-mantle': equipmentRecipe('ossuary-mantle', 'Ossuary Mantle', [{ itemId: 'ossuary-remnant', quantity: 4 }, { itemId: 'soul-residue', quantity: 3 }, { itemId: 'earth-fragment', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 20000, abandonedCatacombs, 'General Catacombs defense.'),
  'soulglass-amulet': equipmentRecipe('soulglass-amulet', 'Soulglass Amulet', [{ itemId: 'graveglass-shard', quantity: 5 }, { itemId: 'soul-residue', quantity: 3 }, { itemId: 'fire-fragment', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 20000, abandonedCatacombs, 'A Burning and future DoT build amulet.'),
  'gravebinder-ring': equipmentRecipe('gravebinder-ring', 'Gravebinder Ring', [{ itemId: 'graveglass-shard', quantity: 5 }, { itemId: 'soul-residue', quantity: 3 }, { itemId: 'prismatic-fragment', quantity: 2 }], 18000, abandonedCatacombs, 'A universal status-build ring.'),
  'edrins-signet': equipmentRecipe('edrins-signet', "Edrin's Signet", [{ itemId: 'edrin-remnant', quantity: 5 }], 30000, { type: 'boss-kill', bossId: 'archmage-edrin-shade' }, "Edrin remnants shaped into the Archmage's warding signet."),
}

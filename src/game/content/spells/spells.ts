...
export const SPELLS = {
  'fire-bolt': spell({ id: 'fire-bolt', name: 'Fire Bolt', school: 'fire', description: 'A quick bolt of flame. It does not burn.', unlockLevel: 0, manaCost: 30, castTimeMs: 1000, cooldownMs: 3500, type: 'damage', effects: [damage('fire', 0.75)], autoCondition: { type: 'always' } }),
  ...
  'flame-burst': spell({ id: 'flame-burst', name: 'Flame Burst', school: 'fire', description: 'A heavy burst that deals 50% more damage to Burning enemies.', unlockLevel: 8, manaCost: 55, castTimeMs: 1500, cooldownMs: 14000, type: 'damage', effects: [damage('fire', 0.6)], autoCondition: { type: 'always' } }),
  ...
  'water-bolt': spell({ id: 'water-bolt', name: 'Water Bolt', school: 'water', description: 'A bolt of water that Chills its target.', unlockLevel: 0, manaCost: 20, castTimeMs: 1000, cooldownMs: 3000, type: 'damage', effects: [damage('water', 0.4), status('opponent', 'chilled', 5000, ['debuff', 'control', 'water'])], autoCondition: { type: 'always' } }),
  ...
  'stone-shard': spell({ id: 'stone-shard', name: 'Stone Shard', school: 'earth', description: 'Strikes the enemy and fractures it over three seconds.', unlockLevel: 0, manaCost: 25, castTimeMs: 1700, cooldownMs: 4000, type: 'dot', effects: [damage('earth', 0.25), periodicDamageStatus({ statusId: 'earth-fracture', durationMs: 3000, totalMagnitude: { type: 'spell-power', coefficient: 0.25 }, damageType: 'earth' })], autoCondition: { type: 'always' } }),
  ...
  'earthen-barrier': spell({ id: 'earthen-barrier', name: 'Earthen Barrier', school: 'earth', description: 'Creates a strong barrier, replacing it only when stronger.', unlockLevel: 8, manaCost: 60, castTimeMs: 1800, cooldownMs: 14000, type: 'barrier', effects: [barrier(1.2)], autoCondition: { type: 'barrier-below', value: 10 } }),
  ...
  'wind-blade': spell({ id: 'wind-blade', name: 'Wind Blade', school: 'air', description: 'A swift blade of compressed air.', unlockLevel: 0, manaCost: 25, castTimeMs: 650, cooldownMs: 2500, type: 'damage', effects: [damage('air', 0.4)], autoCondition: { type: 'always' } }),
  ...
  gust: spell({ id: 'gust', name: 'Gust', school: 'air', description: 'The next Spell cast resolves with 30% less work.', unlockLevel: 8, manaCost: 65, castTimeMs: 600, cooldownMs: 12000, type: 'damage', effects: [damage('air', 0.5), status('self', 'gust', 6000, ['buff', 'air'])], autoCondition: { type: 'always' } }),

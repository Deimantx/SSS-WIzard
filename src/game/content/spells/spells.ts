...
export const SPELLS: Record<SpellId, SpellDefinition> = {
  'fire-bolt': { id: 'fire-bolt', name: 'Fire Bolt', school: 'fire', description: 'A fast, reliable bolt of flame.', unlockLevel: 2, manaCost: 30, cooldownMs: 5000, type: 'damage', effects: [damage('fire', 0.6)], autoCondition: { type: 'always' } },
  ...
  fireball: { id: 'fireball', name: 'Fireball', school: 'fire', description: 'A heavy sphere of flame that erupts on impact and leaves a lasting burn.', unlockLevel: 16, manaCost: 60, cooldownMs: 12000, type: 'damage', effects: [damage('fire', 1), periodicDamageStatus({ statusId: 'burning', durationMs: 10000, totalMagnitude: { type: 'spell-power', coefficient: 0.2 }, damageType: 'fire' })], autoCondition: { type: 'always' } },
  ...
  frostbite: { id: 'frostbite', name: 'Frostbite', school: 'water', description: 'Bites into the enemy with cold and slows its combat tempo.', unlockLevel: 16, manaCost: 45, cooldownMs: 15000, type: 'damage', effects: [damage('water', 0.65), { type: 'apply-status', target: 'opponent', statusId: 'chilled', tags: ['debuff', 'control'] }], autoCondition: { type: 'always' } },
  'earth-spike': { id: 'earth-spike', name: 'Earth Spike', school: 'earth', description: 'A heavy spike that strikes with earthen force.', unlockLevel: 2, manaCost: 28, cooldownMs: 7000, type: 'damage', effects: [damage('earth', 0.85)], autoCondition: { type: 'always' } },
  ...
  'air-lance': { id: 'air-lance', name: 'Air Lance', school: 'air', description: 'A focused lance of compressed air that strikes the enemy.', unlockLevel: 2, manaCost: 24, cooldownMs: 8000, type: 'damage', effects: [damage('air', 0.6)], autoCondition: { type: 'always' } },

...
export const STATUS_DEFINITIONS: Record<StatusId, StatusDefinition> = {
  ...
  haste: {
    id: "haste",
    name: "Haste",
    description: "All action cadence is increased by 15%.",
    classification: "buff",
    tags: ["buff"],
    defaultDurationMs: null,
    stacking: { mode: "refresh" },
    modifiers: [modifier("action-speed-percent", 0.15), modifier("basic-attack-speed-percent", 0.15)],
    cleanseable: false,
    dispellable: true,
  },
  "spectral-fade": {
  ...
  "corrupted-fury": {
    id: "corrupted-fury",
    name: "Corrupted Fury",
    description: "Deals 10% more damage for the rest of the encounter.",
    classification: "buff",
    tags: ["buff", "arcane"],
    defaultDurationMs: null,
    stacking: { mode: "refresh" },
    modifiers: [modifier("damage-dealt-percent", 0.1)],
    cleanseable: false,
    dispellable: false,
  },
  "unbound-power": {
    id: "unbound-power",
    name: "Unbound Power",
    description: "Deals 20% more damage for the rest of the encounter.",
    classification: "buff",
    tags: ["buff", "arcane"],
    defaultDurationMs: null,
    stacking: { mode: "refresh" },
    modifiers: [modifier("damage-dealt-percent", 0.2)],
    cleanseable: false,
    dispellable: false,
  },
  "final-incantation-empowerment": {
    ...
    description: "Each resolved Final Incantation permanently increases later casts by 10% for this encounter.",
    classification: "buff",
    tags: ["buff", "arcane"],
    defaultDurationMs: null,
    stacking: { mode: "stacks" },
    cleanseable: false,
    dispellable: false,
  },
};

...
export const BALANCE = {
  ...
  channeling: { baseArcaneFluxCapacity: 500, baseFluxPerAcolytePerSecond: 2, harmonicWorkforceAcolytes: 3, discoveryEchoMultiplier: 1.1, stableLeylineThreshold: 2500, echoResonanceDurationMs: 120000, deepReservoirThreshold: 1500, deepReservoirCapacityBonus: 250, echoFocusCost: 10, maxEchoes: 5 },
  focus: { startingMax: 100, forestHeartBonus: 10, guildApprenticeBonus: 10 },
  research: { maxPreparedSlots: 4, arcaneFluxPerItem: 5, durationPerItemMs: 10000, matchingXp: 12, nonMatchingXp: 8, maxEchoes: 5, echoFocusCost: 10, manaCostPerItem: 30 },

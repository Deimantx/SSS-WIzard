...
export const BALANCE = {
  tickMs: 100,
  player: { maxHealth: 100, healthRegenPerSecond: 1, outOfCombatRegenMultiplier: 5, basicAttackDamage: 8, basicAttackIntervalMs: 2200, baseSpellPower: 100, baseDefense: 10, baseCritChance: 0.05, baseCritDamage: 1.5 },

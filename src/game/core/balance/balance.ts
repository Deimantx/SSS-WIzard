...
export const BALANCE = {
  tickMs: 100,
  player: { maxHealth: 100, healthRegenPerSecond: 1, healthRegenIntervalMs: 1000, outOfCombatRegenMultiplier: 2, basicAttackDamage: 5, basicAttackIntervalMs: 2200, baseSpellPower: 50, baseDefense: 5, baseCritChance: 0.05, baseCritDamage: 1.5 },

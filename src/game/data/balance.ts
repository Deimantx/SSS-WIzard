...
export const BALANCE = {
  ...
  channeling: { baseNaturalRegenPerSecond: 5, echoFocusCost: 10, echoManaPerSecond: 5, maxEchoes: 5, reservoirCapacityPerRank: 25, conduitManaRegenPerRank: 1, discoveryEchoMultiplier: 1.1, stableLeylineThreshold: 2500, echoResonanceDurationMs: 120000, deepReservoirThreshold: 225, deepReservoirCapacityBonus: 25 },

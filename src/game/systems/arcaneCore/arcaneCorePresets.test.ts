...
describe('Arcane Core V6 runtime presets', () => {
  ...
  it('validates multi-Ring gates, Major gates, caps, and weighted Major points', () => {
    ...
    expect(getArcaneCorePresetSummary({ nodes: { 'power-r1-overwhelming-force': { rank: 1 } } })).toMatchObject({ nodes: 1, ranks: 1, points: 4, majors: 1 })

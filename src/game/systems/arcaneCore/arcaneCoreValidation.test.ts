...
describe('Arcane Core V3 catalog', () => {
  it('contains four Cores with four Rings of eight standards and one Major', () => {
    ...
    for (const branch of ARCANE_CORE_BRANCHES) for (let ring = 1; ring <= 4; ring += 1) {

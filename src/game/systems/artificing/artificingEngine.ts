...
export const canCraftArtificingRecipe = (state: Pick<GameState, 'progress' | 'inventory' | 'protectedItems' | 'equipment' | 'activities'>, recipeId: RecipeId) => {
...
export const craftArtificingRecipe = (state: GameState, recipeId: RecipeId): ArtificingCraftResult => {

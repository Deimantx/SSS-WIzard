...
import { getActionRate, getCurrentEnemyActionRate, startEnemyAction, clearCurrentEnemyAction } from './actionRuntime'
...
describe('combat foundation hardening', () => {
  ...
  it('preserves Enemy Skill progress while Player Status control changes', () => {

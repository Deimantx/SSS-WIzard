...
import type { DamageType, MonsterId } from '../../game/types'
...
export function CombatIntelPanel() {
  ...
  return <Card title="COMBAT INTEL" className="combat-intel-panel"><Tabs items={intelTabs} active={tab} onChange={setTab} />{tab === 'ENEMY INTEL' && <EnemyIntelTab />}{tab === 'LOOT' && <LootIntelTab />}{tab === 'COMBAT LOG' && <CombatLogTab />}</Card>
}

function EnemyIntelTab() {
...
export const damageTypeLabels: Record<DamageType, string> = { physical: 'Physical', arcane: 'Arcane', fire: 'Fire', water: 'Water', earth: 'Earth', air: 'Air' }

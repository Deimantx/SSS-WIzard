...
import { isWorldMapUnlocked } from './combatNavigationReadModel'
...
export function CombatRunBar({ selectedDungeonId, onOpenAtlas, onRequestLeave }: { selectedDungeonId: DungeonId; onOpenAtlas: (mode?: CombatNavigationMode) => void; onRequestLeave: () => void }) {
  ...
  const worldMapUnlocked = isWorldMapUnlocked(progress)

...
export function CombatWorldTierControl() {
  ...
  return <Card className="combat-world-tier-control">
    ...
    <small className="combat-world-tier-status">{current.active ? 'Leave the current dungeon to change World Tier.' : current.highest > 1 ? `WT1 and WT${current.highest} available.` : 'WT2 unlocks after Chapter 1.'}</small>
  </Card>
}

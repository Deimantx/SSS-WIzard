...
export function EquipmentScreenV2() {
  ...
  const statsPanel = <Card title="WIZARD STATS" action={<Sparkles size={16} color="var(--gold)" />}>
    <div className="equipment-stat-groups">
      <StatGroup title="CORE" rows={[['Health', String(statSnapshot.maxHealth)], ['Max Mana', String(statSnapshot.maxMana)], ['Max Focus', String(statSnapshot.maxFocus)], ['Mana Regen', `+${statSnapshot.manaRegen.toFixed(1)}/s`]]} />

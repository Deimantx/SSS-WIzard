...
export function InventoryScreenV2() {
  ...
  const actionsPanel = <Card className="inventory-actions-card"><InventoryActions itemId={selected} inventory={inventory} protectedItems={protectedItems} equipment={equipment} toggleProtection={toggleProtection} equipItem={equipItem} sellItem={sellItem} destroyItem={destroyItem} /></Card>

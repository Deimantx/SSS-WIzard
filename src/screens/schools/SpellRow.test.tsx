    ...
    <TooltipProvider>
      <GameContextMenuProvider>
        <SpellLoadoutDndProvider onCommit={() => undefined}>
          <SpellRow entry={entry} state={state} selected={false} equipped={false} newSpell={false} canEdit onSelect={vi.fn()} onEquip={vi.fn()} onRemove={vi.fn()} onConfigureAutomation={vi.fn()} />

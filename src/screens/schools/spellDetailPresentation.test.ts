...
describe('spell detail presentation', () => {
  it('aggregates authored spell metadata and canonical effect rows', () => {
    ...
    expect(detail).toMatchObject({ spellId: 'fire-bolt', spellName: 'Fire Bolt', school: 'fire', rankLabel: 'Rank I', description: expect.any(String), manaCost: 30, cooldownLabel: '3.5s', autoCastFocus: 0, autoCastActive: false })
    ...
    expect(row(cardRows, 'Ember Staff')).toBeUndefined()

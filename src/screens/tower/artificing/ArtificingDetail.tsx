...
import { getArtificingProfile, canCraftArtificingRecipe, getArtificingCraftCapacity, getArtificingLimitingIngredient } from '../../../game/systems/artificing/artificingSelectors'
...
export function ArtificingDetail({ recipe }: { recipe: ArtificingRecipeDefinition | null }) {
  ...
  return <Card className="artificing-detail" title="ARCANE FORGE">
    <div className="artificing-detail-content">
      ...
      <p className="artificing-description">{item.description}</p>

...
const REQUIRED_ITEMS = ['prismatic-fragment'] as const
...
export function FocusImprovementPanel() {
  ...
  const missingItem = cost ? REQUIRED_ITEMS.find((itemId) => getConsumableQuantity(state, itemId) < cost.primary) : undefined

...
import { getPreparedResearchCount, getResearchAssignOneEachState, getResearchEchoCapacity, getResearchAcolytesAssigned, getResearchJob } from '../../../game/systems/research/researchSelectors'
...
export function PreparedResearch() {
  ...
  const bulkTooltip = bulkAssignment.blockedReason === 'no-targets'
    ...
    : bulkAssignment.blockedReason === 'echo-capacity'
      ? `Not enough Acolytes for every batch. Need ${bulkAssignment.targetCount} workers; ${bulkAssignment.freeEchoSlots} are available.`

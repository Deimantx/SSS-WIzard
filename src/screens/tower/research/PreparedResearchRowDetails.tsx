...
import { getResearchEchoFocusCost, getResearchJobXpPerItem, getResearchNextLevelEtaMs } from '../../../game/systems/research/researchSelectors'
...
export function PreparedResearchRowDetails({ slotId, job, schoolProgress, nextLevelText }: { slotId: ResearchSlotId; job: ResearchJobState; schoolProgress: ReturnType<typeof getSchoolProgressInfo>; nextLevelText: string }) {
  ...
  const focusReserved = Math.max(0, Math.floor(job.echoesAssigned)) * getResearchEchoFocusCost()

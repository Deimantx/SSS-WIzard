...
export function ResearchInspector({ itemId }: { itemId: ItemId | null }) {
  ...
  return <Card className="research-inspector" title="ITEM INSPECTION">
    ...
    <section className="research-inspector-section"><span className="eyebrow">RESEARCH VALUE</span><div className="research-value-grid"><Metric label="XP / ITEM" value={String(xpPerItem)} /><Metric label="BASE TIME" value={formatTime(BALANCE.research.durationPerItemMs)} /><Metric label="MANA / ITEM" value={formatResourceAmount(BALANCE.research.manaCostPerItem)} /></div></section>
    ...
    <div className="research-inspector-total"><Metric label="TOTAL XP" value={formatNumber(safeQuantity * xpPerItem)} /><Metric label="BASE TIME" value={formatTime(safeQuantity * BALANCE.research.durationPerItemMs)} /><Metric label="TOTAL MANA" value={formatResourceAmount(safeQuantity * BALANCE.research.manaCostPerItem)} /></div>

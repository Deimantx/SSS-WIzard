...
export function TransmutationScreen() {
  ...
  return <TowerFrame className="transmutation-screen" eyebrow="WIZARD TOWER · TRANSMUTATION" title="Shape Resonance into elemental matter." description="Assign Acolytes to continuously refine elemental fragments and prismatic matter using Arcane Flux."><ScreenGrid screen="tower-transmutation" panels={panels} /></TowerFrame>
}

...
// Combat foundation V12 adds explicit barrier timing and namespaced trigger state.
...
export const createInitialState = (): GameState => ({
  ...
  combat: { active: false, dungeonId: null, enemyId: null, enemyHp: 0, enemyMaxHp: 0, enemyBarrier: 0, playerBarrier: 0, enemyBarrierRemainingMs: null, playerBarrierRemainingMs: null, enemyActionIndex: 0, enemyActionTimerMs: 0, enemyIntervalMs: 0, enemyTelegraphMs: 0, enemyTelegraphActionId: null, triggeredRuleIds: [], pendingBossId: null, playerAttackTimerMs: 0, encounterTimerMs: 0, spellCooldowns: { 'fire-bolt': 0, 'water-ward': 0, 'earth-spike': 0, 'air-lance': 0, ignite: 0, 'flow-mend': 0, stoneguard: 0, quickening: 0 }, playerStatuses: [], enemyStatuses: [], threatCleared: 0, inBossFight: false, log: [], lastDamageDealt: 0, lastDamageTaken: 0 },

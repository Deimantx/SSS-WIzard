...
export const getAmbientProfile = (screen: ScreenId, colors: ThemeColors): AmbientProfile => {
  ...
  if (screen === 'arcane-core') return { ...base, id: 'arcane-core-mana', accentColor: '#9c82ff', secondaryColor: '#6fc6ff', intensity: 0.92, fogOpacity: 0.32, vignetteOpacity: 0.3, particleSpeed: 0.64, biasX: '56%', biasY: '34%', driftDuration: 22 }

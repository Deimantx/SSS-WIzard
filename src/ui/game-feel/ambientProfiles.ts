...
export const getAmbientProfile = (screen: ScreenId, colors: ThemeColors): AmbientProfile => {
  ...
  if (screen === 'arcane-core') return { ...base, id: 'arcane-core-focus', accentColor: '#9c82ff', secondaryColor: '#6fc6ff', intensity: 0.92, fogOpacity: 0.32, vignetteOpacity: 0.3, particleSpeed: 0.64, biasX: '56%', biasY: '34%', driftDuration: 22 }
  if (screen === 'crystals') return { ...base, id: 'crystal-resonance', accentColor: '#c9a8ff', secondaryColor: '#73dfff', intensity: 0.9, fogOpacity: 0.34, vignetteOpacity: 0.3, particleSpeed: 0.68, biasX: '58%', biasY: '28%', driftDuration: 20 }

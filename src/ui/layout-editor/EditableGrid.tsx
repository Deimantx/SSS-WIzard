...
export function EditableGrid({ screen, panels, children, layoutTransform }: { screen: ScreenId; panels?: EditableGridPanel[]; children?: ReactNode; layoutTransform?: EditableGridLayoutTransform }) {
  ...
  const displayGrid = useMemo(() => {
    if (!((screen === 'inventory' || screen === 'collection' || screen === 'bestiary' || screen === 'tower-focus' || screen === 'tower-transmutation' || screen === 'tower-research') && width > 0 && width < 760)) return transformedGrid
    let nextY = 0

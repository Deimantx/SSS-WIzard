...
export const DEFAULT_LAYOUTS: Record<ScreenId, ScreenLayouts> = {
  ...
  'tower-transmutation': { 'transmutation-recipes': layout(0, 0, 7, 15), 'transmutation-focus': layout(0, 15, 7, 10), 'transmutation-detail': layout(7, 0, 5, 8), 'transmutation-output-preview': layout(7, 8, 5, 19) },
  schools: {

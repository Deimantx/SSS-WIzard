...
export const DEFAULT_LAYOUTS: Record<ScreenId, ScreenLayouts> = {
  ...
  'tower-channeling': { 'channeling-mana-core': layout(0, 0, 6, 9), 'channeling-echoes': layout(6, 0, 6, 9), 'channeling-breakdown': layout(0, 9, 7, 15), 'channeling-pillars': layout(7, 9, 5, 15) },

...
export const DEFAULT_LAYOUTS: Record<ScreenId, ScreenLayouts> = {
  ...
  'tower-transmutation': { 'transmutation-recipes': layout(0, 0, 7, 15), 'transmutation-focus': layout(0, 15, 7, 15), 'transmutation-detail': layout(7, 0, 5, 8), 'transmutation-output-preview': layout(7, 8, 5, 19) },
  'tower-artificing': { 'artificing-catalog': layout(0, 0, 5, 18), 'artificing-detail': layout(5, 0, 7, 18), 'artificing-inspection': layout(0, 18, 12, 18) },
  schools: {

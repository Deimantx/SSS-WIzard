...
const labels: Record<string, string> = {
  ...
  'channeling-mana-core': 'Mana Core', 'channeling-echoes': 'Arcane Echoes', 'channeling-infrastructure': 'Channeling Infrastructure', 'focus-summary': 'Focus summary', 'focus-reservations': 'Focus reservations', 'condensation-elements': 'Elemental condensation', 'condensation-status': 'Condensation status', 'research-config': 'Research config', 'research-queue': 'Research queue', 'transmutation-recipes': 'Transmutation recipes', 'transmutation-detail': 'Transmutation detail',

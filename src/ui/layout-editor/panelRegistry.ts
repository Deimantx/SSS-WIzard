...
const labels: Record<string, string> = {
  ...
  'inventory-catalog': 'Item Vault', 'inventory-detail': 'Item Details', 'equipment-loadout': 'Equipment loadout', 'equipment-stats': 'Equipment stats', 'equipment-owned': 'Owned equipment',

...
const labels: Record<string, string> = {
  ...
  'channeling-mana-core': 'Mana Core', 'channeling-echoes': 'Arcane Echoes', 'channeling-breakdown': 'Channeling Breakdown', 'channeling-pillars': 'Pillars of Mana', 'focus-summary': 'Focus overview', 'focus-reservations': 'Active Focus usage', 'focus-improvement': 'Focus improvement', 'research-school-mastery': 'Magic School Mastery', 'research-library': 'Researchable items', 'research-inspector': 'Item inspection', 'research-prepared': 'Prepared Research', 'transmutation-recipes': 'Recipe library', 'transmutation-focus': 'Focus assignment', 'transmutation-detail': 'Recipe detail', 'transmutation-arrays': 'Transmutation Arrays',
...
const panelOverrides: Record<string, PanelOverrides> = {
  ...
  'transmutation-detail': { minW: 4, minH: 8, heightMode: 'content' },
  'transmutation-arrays': { minW: 4, minH: 12, heightMode: 'bounded-scroll' },

...
const labels: Record<string, string> = {
  ...
  'channeling-main': 'Channeling chamber', 'channeling-stats': 'Channeling stats', 'focus-summary': 'Focus summary', 'focus-reservations': 'Focus reservations', 'condensation-elements': 'Elemental condensation', 'condensation-status': 'Condensation status', 'research-config': 'Research config', 'research-queue': 'Research queue', 'transmutation-recipes': 'Transmutation recipes', 'transmutation-detail': 'Transmutation detail',

...
const labels: Record<string, string> = {
  ...
  'channeling-mana-core': 'Mana Core', 'channeling-echoes': 'Arcane Echoes', 'channeling-pillars': 'Pillars of Mana', 'focus-summary': 'Focus summary', 'focus-reservations': 'Focus reservations', 'research-config': 'Research config', 'research-queue': 'Research queue', 'transmutation-recipes': 'Recipe library', 'transmutation-detail': 'Recipe detail', 'transmutation-focus': 'Focus assignment',

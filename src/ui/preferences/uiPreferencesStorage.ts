...
export const defaultScreenPreferences = (): ScreenPreferences => ({
  ...
  combat: { combatLogFontSize: 'medium', combatLogCollapsed: false, lastExpandedCombatLogH: 7, combatDetailsMode: 'damage-done' },
})

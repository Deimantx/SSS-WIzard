...
export const defaultScreenPreferences = (): ScreenPreferences => ({
  ...
  transmutation: { selectedRecipeId: RECIPE_ORDER[0], categoryFilter: 'all', equipmentSlotFilter: 'all', weaponHandsFilter: 'all', offhandPresentationFilter: 'all', materialTierFilter: 'all', craftableOnly: false, activeOnly: false, collapsedCategories: { elemental: false, material: false, equipment: false, special: false } },
